...
/**
  ...
  **/
object EntIdCurrPerson extends Until{
...
//    saveASMysqlTable(res,"ods_policy_ent_curr_insured",SaveMode.Overwrite)
    hiveContext.sql("truncate table odsdb_prd.ods_policy_ent_curr_insured")
    res.repartition(1).write.mode(SaveMode.Append).saveAsTable("odsdb_prd.ods_policy_ent_curr_insured")
    //odsPolicyEntCurrInsured
    sc.stop()
  }
