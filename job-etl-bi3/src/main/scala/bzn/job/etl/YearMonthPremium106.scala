...
/**
  ...
  * 保费，精确到天，有年单的也有月单的
  */
object YearMonthPremium106 extends Until with BiUntil {
  ...
  //toMysql
  def toMsql(bzn_year: RDD[(String, String, String, String, String, String,
    String, String, Double, String)], path_hdfs: String, path: String): Unit = {
  ...
  //月单
  def month_premium(sqlContext: HiveContext, res: DataFrame, bp_bro: Broadcast[Array[String]])
  : RDD[(String, String, String, String, String, String, String, String, Double, String)] = {

    val ods_policy_product_plan = sqlContext.sql("select * from odsdb_prd.ods_policy_product_plan")
      .filter("length(sku_price)>0 and sku_charge_type=1")
      .cache()
  ...
  //年单
  def year_premium(sqlContext: HiveContext, res: DataFrame, bp_bro: Broadcast[Array[String]])
  : RDD[(String, String, String, String, String, String, String, String, Double, String)] = {

    val ods_policy_product_plan = sqlContext.sql("select * from odsdb_prd.ods_policy_product_plan")
      .filter("length(sku_price)>0 and sku_charge_type=2")
      .cache()
    ...
    val to_hive: RDD[(String, String, String, String, String, String, String, String, Double, String)] = bzn_year
      .map(x => (x._2, x._3, x._4, x._5, x._6, x._7, x._8, x._9, x._10, x._11))
    to_hive
...
//      .setMaster("local[2]")
    ...
    //为true表示覆盖
    to_hive.insertInto("odsdb_prd.ods_policy_insured_charged_vt_test", overwrite = true)
