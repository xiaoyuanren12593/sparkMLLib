//package robot_data.statistics_all
//
...
//  **/
//
//object robot_streaming_test01 extends robot_until_base.until {
//  /**
//    * 机器人工种回答
//    **/
...
//                      json_topic_end_work: JSONObject): Array[((String, String), Int)]
//  = {
//
...
//    val all_before: Array[((String, String), Int)] = getProduct_result_work_all(robot_data_json_work_type: Array[String], str: String)
//
//
//    all_before
//  }
...
//    )
//    val topicSet: Set[String] = Set("mk_ceshi")
...
//
//              //走工种匹配
//              else if (x._1.contains("mk")) {
//                val json_topic_work = JSON.parseObject(x._2)
////                loggers.info("------接受到了kafka的数据------" + json_topic_work)
//
//                val str = json_topic_work.getString("searchStr")
//
//                val work_robot = robot_work_type(x: (String, String), loggers: log4j.Logger, stop: StopRecognition, filter_directory: Seq[String], normal_classification_of_work: Array[String], ods_policy_worktype_map: Array[String], json_topic_end_work: JSONObject)
//                /**
//                  * 这里全取出来
//                  **/
//                work_robot.foreach(x => {
//                  val before_just_one_jsonObject = new JSONObject
//                  val all_value = JSON.parseObject(x._1._2)
...
//            }
//            catch {
//              case e: Exception => loggers.error("数据计算报错------" + e.getMessage)
//            }
//          })
//        })
//      }
