...
object TreeDemo {
  ...
  def main(args: Array[String]) {
    ...
    //训练数据
    val data1 = sc.textFile("C:\\Users\\xingyuan\\Desktop\\未完成\\7.机器学习-核赔模型\\data\\Tree1.txt")

    //测试数据
    val data2 = sc.textFile("C:\\Users\\xingyuan\\Desktop\\未完成\\7.机器学习-核赔模型\\data\\Tree2.txt")
