...
object read_dataTo_hive {
  ...
  def main(args: Array[String]): Unit = {
    ...
    rdd.map(x => {
      ...
      //死亡案件数
      val death_number = all(9).split(":")(1) + ""
      //伤残案件数
      val disable_number = all(10).split(":")(1) + ""
      //报案总数
      val number = all(13).split(":")(1) + ""

      //平均出险周期
      val avg_risk_cycle = all(14).split(":")(1) + ""

      //企业的潜在客户
      val potential_people = all(17) .split(":")(1)+ ""
      //城市名称,并得到城市编码
