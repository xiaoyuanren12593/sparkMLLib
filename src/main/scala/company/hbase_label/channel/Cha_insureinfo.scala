...
import company.hbase_label.channel.Cha_claiminfo._
import company.hbase_label.channel.channel_trait.cha_Insureinfo_until
...
/**
  ...
  */
object Cha_insureinfo extends cha_Insureinfo_until with until {
