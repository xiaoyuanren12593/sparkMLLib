package company.sparkMLlib.loadModel
...
object model_load {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val rdd = sc.parallelize(Array(Array(1, 0, 68.71, 31.29, 28.97, 0, 0, 0, 0, 0, 0, 0, 0, 41360, 1),Array (1, 0, 68.71, 31.29, 28.97, 0, 0, 0, 0, 0, 0, 0, 0, 41360, 1)))
