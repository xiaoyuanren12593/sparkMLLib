package company.sparkMLlib.personal

import com.alibaba.fastjson.JSON
import company.hbase_label.personal.Cbaseinfo.HbaseConf
...
object read_hbaseTo_hive extends until {
  ...
  = {
    val res_k_means: RDD[(String, String, String, String, String, String, String, String, String)] = usersRDD.mapPartitions(rdd => {
      rdd.map(x => {
